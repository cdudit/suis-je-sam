...
class _DashboardState extends State<Dashboard> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: myAlcool('images/wine.png', DrinkTitle.wine, wines),
                  ),
                  Container(
                    padding: EdgeInsets.only(bottom: 20),
                    child: myAlcool(
                        'images/whisky.png', DrinkTitle.whisky, whiskies),
                  ),
                ],
              ),
            ),
  ...
  ClayContainer beerMlContainer(int ml) {
    return ClayContainer(
        ...
        child: TextButton(
            ...
            child:
                Text("${(ml / 10).round()}", style: TextStyle(fontSize: 20))));
  }
      ...
      [beers, wines, whiskies].forEach((element) {
        if (element.isNotEmpty) {
          element.forEach((element) {
            rawTx += (element.ml * element.degree * 0.8) /
                (userWeight * userGenderTx);
          });
        }
      });
  ...
  void decrementTaux() {
    if ((wines.isNotEmpty || beers.isNotEmpty || whiskies.isNotEmpty) &&
        rawTx > 0) {
      setState(() {
